function Hero() {
  return (
    <section className="pt-20 min-h-[90vh] flex items-center bg-gradient-to-br from-slate-50 to-teal-50 px-4 sm:px-8">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        {/* Text content */}
        <div className="text-center md:text-left">
          <span className="inline-block bg-amber-100 text-amber-700 text-xs sm:text-sm font-medium px-3 py-1 rounded-full mb-4">
            Aligarh Campus
          </span>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-800 leading-tight mb-4">
            Nurturing Future Leaders Through <span className="text-teal-700">Holistic Education</span>
          </h1>
          <p className="text-slate-600 text-sm sm:text-base mb-6 max-w-md mx-auto md:mx-0">
